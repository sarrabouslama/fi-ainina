export default function StatCard({ icon: Icon, label, value, sub, color = 'var(--green)', delay = 0 }) {
  return (
    <div className="glass rounded-2xl p-5 animate-fade-up" style={{ animationDelay: `${delay}s` }}>
