...
EMOTION_CONFIDENCE_THRESHOLD: float = _get_float("EMOTION_CONFIDENCE_THRESHOLD", 0.25)
...
REDNESS_MILD_THRESHOLD: float = max(_get_float("REDNESS_MILD_THRESHOLD", 0.40), 0.20)
REDNESS_HIGH_THRESHOLD: float = max(_get_float("REDNESS_HIGH_THRESHOLD", 0.60), 0.60)
SATURATION_RELIABLE_THRESHOLD: float = _get_float("SATURATION_RELIABLE_THRESHOLD", 22.0)